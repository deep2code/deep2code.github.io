...
def build_homepage_content(pages):
    ...
    # === 码农进化史宣传片 — 循环动画 ===
    # --- Age-progressive character SVGs (22→42 years old) ---
    _DEV_BODY = (
    ...
    _DEV_NOSE = '<path d="M100 98 L98 105 Q100 107 102 105 Z" fill="#D4A070" opacity="0.5"/>'

    def _dev_head(idx):
        """Head/face SVG for life stage idx (0-5: ages 22→42)."""
        # Shared: ears already in body; nose appended outside
        if idx == 0:
            # 22岁: 浓密乱发、无眼镜、大笑、腮红
            return (
                '<path d="M56 86 Q52 30 100 30 Q148 30 144 86 Q138 48 116 45 Q108 38 100 38 Q92 38 84 45 Q62 48 56 86 Z" fill="#2D1B0E"/>'
                '<path d="M58 86 Q55 96 59 104 L63 88 Z" fill="#2D1B0E"/>'
                '<path d="M142 86 Q145 96 141 104 L137 88 Z" fill="#2D1B0E"/>'
                '<path d="M64 73 Q78 68 92 73" stroke="#2D1B0E" stroke-width="4" fill="none" stroke-linecap="round"/>'
                '<path d="M108 73 Q122 68 136 73" stroke="#2D1B0E" stroke-width="4" fill="none" stroke-linecap="round"/>'
                '<circle cx="78" cy="89" r="4.5" fill="#1a1a2e"/>'
                '<circle cx="122" cy="89" r="4.5" fill="#1a1a2e"/>'
                '<circle cx="80" cy="87" r="1.8" fill="#fff"/>'
                '<circle cx="124" cy="87" r="1.8" fill="#fff"/>'
                '<path d="M76 108 Q100 128 124 108" stroke="#1a1a2e" stroke-width="3" fill="none" stroke-linecap="round"/>'
                '<circle cx="64" cy="103" r="7" fill="#FFB088" opacity="0.45"/>'
                '<circle cx="136" cy="103" r="7" fill="#FFB088" opacity="0.45"/>'
            )
        if idx == 1:
            # 26岁: 整齐黑发、细框眼镜、自信微笑
            return (
                '<path d="M58 86 Q58 40 100 38 Q142 40 142 86 Q138 52 118 50 Q112 44 100 44 Q88 44 82 50 Q62 52 58 86 Z" fill="#2D1B0E"/>'
                '<path d="M58 86 Q55 96 59 103 L63 88 Z" fill="#2D1B0E"/>'
                '<path d="M142 86 Q145 96 141 103 L137 88 Z" fill="#2D1B0E"/>'
                '<path d="M68 73 Q78 70 88 73" stroke="#2D1B0E" stroke-width="3.5" fill="none" stroke-linecap="round"/>'
                '<path d="M112 73 Q122 70 132 73" stroke="#2D1B0E" stroke-width="3.5" fill="none" stroke-linecap="round"/>'
                '<circle cx="78" cy="88" r="16" fill="rgba(180,210,255,0.08)" stroke="#1a1a2e" stroke-width="1.5"/>'
                '<circle cx="122" cy="88" r="16" fill="rgba(180,210,255,0.08)" stroke="#1a1a2e" stroke-width="1.5"/>'
                '<path d="M94 88 L106 88" stroke="#1a1a2e" stroke-width="1.5" stroke-linecap="round"/>'
                '<path d="M62 86 L55 81" stroke="#1a1a2e" stroke-width="1.5" stroke-linecap="round"/>'
                '<path d="M138 86 L145 81" stroke="#1a1a2e" stroke-width="1.5" stroke-linecap="round"/>'
                ...
                '<path d="M80 110 Q100 122 120 110" stroke="#1a1a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<circle cx="66" cy="102" r="5" fill="#FFB088" opacity="0.3"/>'
                '<circle cx="134" cy="102" r="5" fill="#FFB088" opacity="0.3"/>'
            )
        if idx == 2:
            # 30岁: 发际线稍退、标准眼镜、沉稳表情、淡眼袋
            return (
                '<path d="M62 86 Q64 50 100 48 Q136 50 138 86 Q134 58 116 56 Q108 50 100 50 Q92 50 84 56 Q66 58 62 86 Z" fill="#2D1B0E"/>'
                '<path d="M58 86 Q55 96 59 101 L63 88 Z" fill="#2D1B0E"/>'
                '<path d="M142 86 Q145 96 141 101 L137 88 Z" fill="#2D1B0E"/>'
                '<path d="M68 73 Q78 70 88 73" stroke="#2D1B0E" stroke-width="3" fill="none" stroke-linecap="round"/>'
                '<path d="M112 73 Q122 70 132 73" stroke="#2D1B0E" stroke-width="3" fill="none" stroke-linecap="round"/>'
                '<circle cx="78" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#1a1a2e" stroke-width="2"/>'
                '<circle cx="122" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#1a1a2e" stroke-width="2"/>'
                '<path d="M94 88 L106 88" stroke="#1a1a2e" stroke-width="2" stroke-linecap="round"/>'
                '<path d="M62 86 L55 81" stroke="#1a1a2e" stroke-width="2" stroke-linecap="round"/>'
                '<path d="M138 86 L145 81" stroke="#1a1a2e" stroke-width="2" stroke-linecap="round"/>'
                '<circle cx="78" cy="89" r="3" fill="#1a1a2e"/>'
                '<circle cx="122" cy="89" r="3" fill="#1a1a2e"/>'
                '<circle cx="79" cy="88" r="1" fill="#fff"/>'
                '<circle cx="123" cy="88" r="1" fill="#fff"/>'
                '<path d="M72 96 Q80 99 88 96" stroke="#999" stroke-width="1" fill="none" opacity="0.4"/>'
                '<path d="M112 96 Q120 99 128 96" stroke="#999" stroke-width="1" fill="none" opacity="0.4"/>'
                '<path d="M84 113 Q100 117 116 113" stroke="#1a1a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<path d="M76 116 Q100 120 124 116" stroke="#777" stroke-width="0.5" fill="none" opacity="0.3"/>'
            )
        if idx == 3:
            # 34岁: 发际线后退、鬓角白发、粗框眼镜、疲惫但坚定
            return (
                '<path d="M66 86 Q68 54 100 52 Q132 54 134 86 Q130 62 114 60 Q106 54 100 54 Q94 54 86 60 Q70 62 66 86 Z" fill="#3D2B1E"/>'
                '<path d="M62 83 Q60 90 62 96 L66 86 Z" fill="#998"/>'
                '<path d="M138 83 Q140 90 138 96 L134 86 Z" fill="#998"/>'
                '<path d="M58 86 Q55 96 59 99 L63 88 Z" fill="#3D2B1E"/>'
                '<path d="M142 86 Q145 96 141 99 L137 88 Z" fill="#3D2B1E"/>'
                '<path d="M68 72 Q78 69 88 72" stroke="#3D2B1E" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<path d="M112 72 Q122 69 132 72" stroke="#3D2B1E" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<circle cx="78" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#333" stroke-width="2.5"/>'
                '<circle cx="122" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#333" stroke-width="2.5"/>'
                '<path d="M94 88 L106 88" stroke="#333" stroke-width="2.5" stroke-linecap="round"/>'
                '<path d="M62 86 L55 81" stroke="#333" stroke-width="2" stroke-linecap="round"/>'
                '<path d="M138 86 L145 81" stroke="#333" stroke-width="2" stroke-linecap="round"/>'
                '<circle cx="78" cy="90" r="3" fill="#1a1a2e"/>'
                '<circle cx="122" cy="90" r="3" fill="#1a1a2e"/>'
                '<circle cx="79" cy="89" r="0.8" fill="#fff"/>'
                '<circle cx="123" cy="89" r="0.8" fill="#fff"/>'
                '<path d="M70 97 Q80 100 88 97" stroke="#a99" stroke-width="1" fill="none" opacity="0.5"/>'
                '<path d="M112 97 Q120 100 128 97" stroke="#a99" stroke-width="1" fill="none" opacity="0.5"/>'
                '<path d="M74 62 Q100 60 126 62" stroke="#a99" stroke-width="0.8" fill="none" opacity="0.35"/>'
                '<path d="M78 68 Q100 66 122 68" stroke="#a99" stroke-width="0.8" fill="none" opacity="0.35"/>'
                '<path d="M84 114 Q100 116 116 114" stroke="#1a1a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<path d="M72 113 Q100 121 128 113" stroke="#666" stroke-width="0.6" fill="none" opacity="0.4"/>'
            )
        if idx == 4:
            # 38岁: 灰棕混合发、粗框眼镜、从容微笑、皱纹、淡胡须
            return (
                '<path d="M68 86 Q70 58 100 56 Q130 58 132 86 Q128 66 114 64 Q106 58 100 58 Q94 58 86 64 Q72 66 68 86 Z" fill="#7B6B5E"/>'
                '<path d="M60 84 Q58 92 60 97 L64 87 Z" fill="#BBB"/>'
                '<path d="M140 84 Q142 92 140 97 L136 87 Z" fill="#BBB"/>'
                '<path d="M58 86 Q55 96 59 98 L63 88 Z" fill="#7B6B5E"/>'
                '<path d="M142 86 Q145 96 141 98 L137 88 Z" fill="#7B6B5E"/>'
                '<path d="M68 72 Q78 69 88 72" stroke="#7B6B5E" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<path d="M112 72 Q122 69 132 72" stroke="#7B6B5E" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<circle cx="78" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#444" stroke-width="2.5"/>'
                '<circle cx="122" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#444" stroke-width="2.5"/>'
                '<path d="M94 88 L106 88" stroke="#444" stroke-width="2.5" stroke-linecap="round"/>'
                '<path d="M62 86 L55 81" stroke="#444" stroke-width="2" stroke-linecap="round"/>'
                '<path d="M138 86 L145 81" stroke="#444" stroke-width="2" stroke-linecap="round"/>'
                '<circle cx="78" cy="90" r="3" fill="#1a1a2e"/>'
                '<circle cx="122" cy="90" r="3" fill="#1a1a2e"/>'
                '<circle cx="79" cy="89" r="0.8" fill="#fff"/>'
                '<circle cx="123" cy="89" r="0.8" fill="#fff"/>'
                '<path d="M72 97 Q80 100 88 97" stroke="#bba" stroke-width="1" fill="none" opacity="0.5"/>'
                '<path d="M112 97 Q120 100 128 97" stroke="#bba" stroke-width="1" fill="none" opacity="0.5"/>'
                '<path d="M74 60 Q100 58 126 60" stroke="#bba" stroke-width="0.8" fill="none" opacity="0.4"/>'
                '<path d="M78 66 Q100 64 122 66" stroke="#bba" stroke-width="0.8" fill="none" opacity="0.4"/>'
                '<path d="M70 105 Q66 114 70 122" stroke="#bba" stroke-width="0.8" fill="none" opacity="0.3"/>'
                '<path d="M130 105 Q134 114 130 122" stroke="#bba" stroke-width="0.8" fill="none" opacity="0.3"/>'
                '<path d="M82 112 Q100 120 118 112" stroke="#1a1a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
                '<path d="M70 114 Q100 126 130 114 L128 122 Q100 128 72 122 Z" fill="#9B8B7E" opacity="0.25"/>'
            )
        # idx == 5: 42岁 灰白头发、眼镜、温暖微笑、更多皱纹、灰白短须
        return (
            '<path d="M70 86 Q72 60 100 58 Q128 60 130 86 Q126 70 114 68 Q106 62 100 62 Q94 62 86 68 Q74 70 70 86 Z" fill="#B5BAC0"/>'
            '<path d="M60 84 Q58 92 60 96 L64 87 Z" fill="#D0D5D8"/>'
            '<path d="M140 84 Q142 92 140 96 L136 87 Z" fill="#D0D5D8"/>'
            '<path d="M58 86 Q55 96 59 97 L63 88 Z" fill="#B5BAC0"/>'
            '<path d="M142 86 Q145 96 141 97 L137 88 Z" fill="#B5BAC0"/>'
            '<path d="M68 72 Q78 69 88 72" stroke="#B5BAC0" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
            '<path d="M112 72 Q122 69 132 72" stroke="#B5BAC0" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
            '<circle cx="78" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#555" stroke-width="2.5"/>'
            '<circle cx="122" cy="88" r="16" fill="rgba(180,210,255,0.1)" stroke="#555" stroke-width="2.5"/>'
            '<path d="M94 88 L106 88" stroke="#555" stroke-width="2.5" stroke-linecap="round"/>'
            '<path d="M62 86 L55 81" stroke="#555" stroke-width="2" stroke-linecap="round"/>'
            '<path d="M138 86 L145 81" stroke="#555" stroke-width="2" stroke-linecap="round"/>'
            '<circle cx="78" cy="90" r="3" fill="#1a1a2e"/>'
            '<circle cx="122" cy="90" r="3" fill="#1a1a2e"/>'
            '<circle cx="79" cy="89" r="0.8" fill="#fff"/>'
            '<circle cx="123" cy="89" r="0.8" fill="#fff"/>'
            '<path d="M72 97 Q80 100 88 97" stroke="#ccb" stroke-width="1" fill="none" opacity="0.5"/>'
            '<path d="M112 97 Q120 100 128 97" stroke="#ccb" stroke-width="1" fill="none" opacity="0.5"/>'
            '<path d="M72 58 Q100 56 128 58" stroke="#ccb" stroke-width="0.8" fill="none" opacity="0.4"/>'
            '<path d="M76 64 Q100 62 124 64" stroke="#ccb" stroke-width="0.8" fill="none" opacity="0.4"/>'
            '<path d="M80 70 Q100 68 120 70" stroke="#ccb" stroke-width="0.8" fill="none" opacity="0.35"/>'
            '<path d="M68 104 Q64 114 68 124" stroke="#ccb" stroke-width="0.8" fill="none" opacity="0.4"/>'
            '<path d="M132 104 Q136 114 132 124" stroke="#ccb" stroke-width="0.8" fill="none" opacity="0.4"/>'
            '<path d="M78 110 Q100 122 122 110" stroke="#1a1a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
            '<path d="M68 112 Q100 128 132 112 L130 124 Q100 130 70 124 Z" fill="#C5CAD0" opacity="0.3"/>'
        )
    _dev_sprite = (
        '<svg style="position:absolute;width:0;height:0;overflow:hidden" aria-hidden="true">'
        + ''.join(
            f'<symbol id="cine-dev-{_i}" viewBox="0 0 200 260">{_DEV_BODY}{_dev_head(_i)}{_DEV_NOSE}</symbol>'
            for _i in range(6)
        )
        + '</svg>'
    )
    journey_scenes = [
        ('2004\u20142008', '\u5c11\u5e74\u610f\u6c14',
         '\u4e8c\u5341\u51fa\u5934\uff0c\u7406\u5de5\u79d1\u6bd5\u4e1a\uff0c\u5bf9\u8ba1\u7b97\u673a\u4e00\u65e0\u6240\u77e5\u5374\u83ab\u540d\u7740\u8ff7\u3002\u522b\u4eba\u6253\u6e38\u620f\u7684\u65f6\u5019\uff0c\u81ea\u5df1\u7a9d\u5728\u5bbf\u820d\u5543\u4ee3\u7801\uff0c\u4e00\u884c\u884c\u6572\u51fa\u6765\uff0c\u50cf\u6253\u5f00\u4e86\u65b0\u4e16\u754c\u7684\u95e8\u3002',
         '#E94560', ['\U0001F4DA', '\u270F\uFE0F', '\U0001F4A1', '\U0001F4D6', '\U0001F4D0'], '\U0001F4D5'),
        ('2008\u20142012', '\u521d\u5165\u6c5f\u6e56',
         '\u51ed\u81ea\u5b66\u7684\u5e95\u5b50\u6572\u5f00\u884c\u4e1a\u5927\u95e8\uff0c\u7b2c\u4e00\u6b21\u4ee5\u5199\u4ee3\u7801\u4e3a\u751f\u3002\u4e0d\u61c2\u7684\u592a\u591a\uff0c\u8e29\u7684\u5751\u4e5f\u591a\uff0c\u4f46\u5e74\u8f7b\u4e0d\u6015\u4e22\u4eba\u2014\u2014\u767d\u5929\u5199 bug\uff0c\u665a\u4e0a debug\uff0c\u6210\u957f\u8089\u773c\u53ef\u89c1\u3002',
         '#00D2D3', ['\U0001F4BC', '\U0001F3E2', '\U0001F5A5\uFE0F', '\U0001F454', '\U0001F511'], '\U0001F6AA'),
        ('2012\u20142016', '\u4e00\u7ebf\u78e8\u783a',
         '\u63a5\u8fd1\u4e09\u5341\uff0c\u4ece\u5199\u529f\u80fd\u5230\u625b\u7cfb\u7edf\uff0c\u4ece\u5355\u4f53\u5230\u5206\u5e03\u5f0f\u3002\u4e0d\u518d\u5e74\u8f7b\u6c14\u76db\uff0c\u5f00\u59cb\u656c\u754f\u751f\u4ea7\u73af\u5883\u3002\u6df1\u591c\u544a\u8b66\u3001\u51cc\u6668\u56de\u6eda\uff0c\u6bcf\u4e00\u4e2a\u5751\u90fd\u662f\u5b66\u8d39\uff0c\u4e5f\u662f\u52cb\u7ae0\u3002',
         '#1B9C85', ['\U0001F41B', '\U0001F527', '\u26A1', '\U0001F4DD', '\U0001F3AF'], '\U0001F4BB'),
        ('2016\u20142020', '\u4e2d\u5e74\u7a81\u56f4',
         '\u4e09\u5341\u51fa\u5934\uff0c\u6280\u672f\u6808\u6362\u4e86\u4e00\u832c\u53c8\u4e00\u832c\u3002Go\u3001\u4e91\u539f\u751f\u3001AI \u8f6e\u756a\u51b2\u51fb\uff0c\u6709\u4eba\u8f6c\u7ba1\u7406\uff0c\u6709\u4eba\u88ab\u6dd8\u6c70\u3002\u9009\u62e9\u7559\u5728\u4e00\u7ebf\uff0c\u54ac\u7259\u8ddf\u4e0a\u65b0\u4e1c\u897f\u2014\u2014\u4e2d\u5e74\u4eba\u7684\u5014\u5f3a\uff0c\u662f\u4e0d\u670d\u8f93\u3002',
         '#C77DFF', ['\U0001F431', '\U0001F40D', '\u2601\uFE0F', '\U0001F916', '\u26A1'], '\U0001F680'),
        ('2020\u20142024', '\u6c89\u6dc0\u8f93\u51fa',
         '\u5feb\u56db\u5341\u4e86\uff0c\u8e29\u8fc7\u7684\u5751\u591f\u5199\u4e00\u672c\u4e66\u3002\u5f00\u59cb\u628a\u7ecf\u9a8c\u6574\u7406\u6210\u535a\u5ba2\uff0c\u4e0d\u662f\u4e3a\u4e86\u6559\u522b\u4eba\uff0c\u662f\u7ed9\u81ea\u5df1\u4e00\u4e2a\u4ea4\u4ee3\u3002\u5199\u7740\u5199\u7740\u53d1\u73b0\uff1a\u5206\u4eab\u662f\u6700\u597d\u7684\u590d\u4e60\uff0c\u8f93\u51fa\u662f\u6700\u6df1\u7684\u8f93\u5165\u3002',
         '#FF6B6B', ['\U0001F4DD', '\U0001F4C4', '\U0001F4A1', '\U0001F4CA', '\U0001F517'], '\u270D\uFE0F'),
        ('2024\u20142026', '\u4f9d\u7136\u5728\u573a',
         '\u56db\u5341\u51fa\u5934\uff0c\u8eab\u8fb9\u5199\u4ee3\u7801\u7684\u540c\u9f84\u4eba\u8d8a\u6765\u8d8a\u5c11\u3002\u4e0d\u662f\u6ca1\u6709\u8f6c\u7ba1\u7406\u7684\u673a\u4f1a\uff0c\u662f\u771f\u5fc3\u820d\u4e0d\u5f97\u952e\u76d8\u3002\u4e8c\u5341\u591a\u5e74\u4e86\uff0c\u770b\u5230\u597d\u4ee3\u7801\u8fd8\u662f\u4f1a\u6fc0\u52a8\uff0c\u9047\u5230\u65b0\u95ee\u9898\u8fd8\u662f\u4f1a\u624b\u75d2\u2014\u2014\u7406\u5de5\u7537\u5230\u4e2d\u5e74\uff0c\u6700\u5927\u7684\u5e78\u8fd0\uff0c\u662f\u70ed\u7231\u672a\u66fe\u892a\u8272\u3002',
    ...
    for _si, (_yr, _ph, _desc, _ac, _floats, _prop) in enumerate(journey_scenes):
        ...
        _scene_parts.append(
            ...
            f'<div class="cine-char" aria-hidden="true"><svg class="cine-dev" viewBox="0 0 200 260" aria-hidden="true"><use href="#cine-dev-{_si}"/></svg></div>'
